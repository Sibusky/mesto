...
## Проектная работа по итогам семи спринтов в Яндекс.Практикуме в курсе "Веб-разработчик".
...
- **JavaScript** (объявление переменных, функции, массивы, объекты, слушатели событий, валидация форм, ООП)
